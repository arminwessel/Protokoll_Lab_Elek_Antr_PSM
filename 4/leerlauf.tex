\begin{figure}[ht!]
    ...
    \begin{axis}[
	   ...
	   grid=major,
		...
		\addplot[smooth,blue,line width=0.5mm] table[x=I_f, y=u_sL, header=has colnames,col sep=comma] {\currfiledir leerlauf_neu02.csv};
		\addlegendentry{gemessen (Mittelung)}
		\addplot[smooth,red,line width=0.5mm] table[x=I_f_corr, y=u_sL_corr, header=has colnames,col sep=comma] {\currfiledir leerlauf_neu02.csv};
